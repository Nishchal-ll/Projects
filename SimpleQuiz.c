...
int main(){
	...
	switch(choice){
		...
		if(score==50){
		printf("Congratulationsss.You have won Iphone 98!!\n",score);
	}
		else{
			printf("Play again to win Iphone 98!!\n");
		}
		break;
		...
		case 3:
		printf("Press 1 to begin the quiz. Enter the correct optionss. If your all answers are correct then get your Iphone 98 and enjoyyyyy!!!!\n\n");
		goto up;
		break;
